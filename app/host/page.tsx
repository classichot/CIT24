    ...
    <div className="login-split">
      <section className="login-pane login-hero">
        ...
        <div className="login-pane-body">
          <h1 className="login-headline">{windowDays}-day Advisor review links</h1>
          <p className="login-lede">
            Each Generate creates a new URL. Send that URL only. After {windowDays} day{windowDays === 1 ? "" : "s"} the same link shows Access ended and will not open CIT24. Customers do not use this page.
          </p>
        </div>
        ...
        <div className="login-pane-body">
          <form className="login-card" onSubmit={onMint}>
            ...
            <p className="text-muted login-card-note">
              The expiry is signed into the URL, so a recipient on another device can open the Siam Precision demo until that clock runs out. Default is {DEFAULT_DAYS} days.
            </p>
            <div className="field">
            ...
            <div className="field">
              ...
              <select className="input" id="hostMode" value={mode} onChange={(e) => setMode(e.target.value as ProductMode)}>
                <option value="advisor">Advisory</option>
                <option value="corporate">Corporate</option>
                <option value="defence">Audit defence</option>
              </select>
            </div>
